...
class UnsuccessfulResponse(StandartResponse):
    message: str


class PayloadsTwoFAResponse(BaseModel):
    two_fa: bool = Field(..., serialization_alias='two_fa')


class PayloadsCapthaResponse(BaseModel):
    captcha: bool
    captcha_key: str
...
class UnsuccessfulLoginResponse(UnsuccessfulResponse):
    payloads: PayloadsCapthaResponse


class SuccessfulResponse(StandartResponse):
    payloads: PayloadsTwoFAResponse | PayloadsCapthaResponse
...
class MainRequestPanelAdminOrders(BaseModel):
    orders: bool = False
    subscriptions: bool = False
    drip_feed: bool = False


class MainRequestPanelAdminSettings(BaseModel):
...
class PanelAdminRules(MainRequestPanelAdmin, MainRequestPanelAdminSettings, MainRequestPanelAdminOrders):
    updates: bool = False
    reports: bool = False
